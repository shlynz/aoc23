...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `203.2µs` | `1.4ms` |
| [Day 2](./src/bin/02.rs) | `813.9µs` | `732.7µs` |
| [Day 3](./src/bin/03.rs) | `1.4ms` | `1.1ms` |
| [Day 4](./src/bin/04.rs) | `43.7µs` | `41.3µs` |
| [Day 5](./src/bin/05.rs) | `25.8µs` | `-` |
| [Day 6](./src/bin/06.rs) | `495.0ns` | `1.1µs` |
| [Day 7](./src/bin/07.rs) | `582.5µs` | `623.1µs` |
