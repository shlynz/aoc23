...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `202.9µs` | `1.4ms` |
| [Day 2](./src/bin/02.rs) | `814.8µs` | `723.0µs` |
| [Day 3](./src/bin/03.rs) | `1.4ms` | `1.1ms` |
| [Day 4](./src/bin/04.rs) | `43.6µs` | `41.2µs` |
| [Day 5](./src/bin/05.rs) | `25.7µs` | `-` |
| [Day 6](./src/bin/06.rs) | `509.0ns` | `1.1µs` |
| [Day 7](./src/bin/07.rs) | `577.6µs` | `619.1µs` |
| [Day 8](./src/bin/08.rs) | `581.2µs` | `-` |
